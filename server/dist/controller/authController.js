...
const generateTokens = (userPayload) => {
    const accessToken = jwt.sign(userPayload, process.env.JWT_SECRET || 'secret', { expiresIn: '15m' });
    const refreshToken = jwt.sign(userPayload, process.env.JWT_REFRESH_SECRET || 'refresh_secret', { expiresIn: '7d' });
